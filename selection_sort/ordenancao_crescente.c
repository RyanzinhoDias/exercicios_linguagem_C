/*Peça ao usuário para digitar 10 números inteiros. Armazene-os em um vetor. Em seguida, 
utilize o algoritmo Selection Sort para ordená-los em ordem crescente e exiba o vetor ordenado.*/
